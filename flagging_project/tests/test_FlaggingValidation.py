...
if max(a) in reduce_step:
    ...
    assert test_output.assigned_variables[VariableInformation("b", None)] == {CodeLocation(3, 0)}
    assert test_output.assigned_variables[VariableInformation("c", None)] == {CodeLocation(4, 0)}
    assert test_output.assigned_variables[VariableInformation("x")] == {CodeLocation(5, 27), CodeLocation(6, 33),
                                                                        CodeLocation(7, 33)}
...
if max(a) in d:
    ...
    assert test_output.assigned_variables[VariableInformation("x")] == {CodeLocation(7, 18), CodeLocation(7, 61),
                                                                        CodeLocation(7, 99)}
